...
import { VirtualAccountComponent } from 'app/entities/coreservice/virtual-account/virtual-account.component';
...
describe('Component Tests', () => {
  describe('VirtualAccount Management Component', () => {
    let comp: VirtualAccountComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VirtualAccountComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.virtualAccounts && comp.virtualAccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
