...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("TollGateNotificationService");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("TollGateNotificationService");
        ...
        config.getMapConfigs().put("com.jhispter.nigeria.domain.*", initializeDomainMapConfig(jHipsterProperties));
